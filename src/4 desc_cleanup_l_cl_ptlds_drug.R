...
table(is.na(clymedrug040118$d_MaintDrugInd)) 
...
summarytools::dfSummary(ptldsdrug040118) %>% summarytools::view() 
...
lymedrug040118$MemberId[is.na(lymedrug040118$d_NationalDrug)] %>% unique %>% length 
clymedrug040118$MemberId[is.na(clymedrug040118$d_NationalDrug)] %>% unique %>% length
ptldsdrug040118$MemberId[is.na(ptldsdrug040118$d_NationalDrug)] %>% unique %>% length 
...
# Lyme
lymedrug040118 %>% nrow 
lymedrug040118 %>% distinct %>% nrow 
lymedrug040118$MemberId %>% unique %>% length 
lymedrug040118$MemberId %>% is.na %>% table 
lymedrug040118$d_NdcDesc %>% table(useNA = "always") 
lymedrug040118 %>% distinct %>% filter(!is.na(d_NdcDesc)) %>% .$MemberId %>% unique %>% length 



# cLyme
clymedrug040118 %>% nrow 
clymedrug040118 %>% distinct %>% nrow 
clymedrug040118$MemberId %>% unique %>% length 
clymedrug040118$MemberId %>% is.na %>% table # no NA in memberID
clymedrug040118$d_NdcDesc %>% table(useNA = "always") 
clymedrug040118 %>% distinct %>% filter(!is.na(d_NdcDesc)) %>% .$MemberId %>% unique %>% length 




# ptlds
ptldsdrug040118 %>% nrow
ptldsdrug040118 %>% distinct %>% nrow 
ptldsdrug040118$MemberId %>% unique %>% length 
ptldsdrug040118$MemberId %>% is.na %>% table # no NA in memberID
ptldsdrug040118$d_NdcDesc %>% table(useNA = "always") 
ptldsdrug040118 %>% distinct %>% filter(!is.na(d_NdcDesc)) %>% .$MemberId %>% unique %>% length
...
lymeanti040118 %>% distinct %>% filter(!is.na(d_NdcDesc)) %>% .$MemberId %>% unique %>% length



# cLyme
clymeanti040118 %>% nrow 
clymeanti040118 %>% distinct %>% nrow 
clymeanti040118$MemberId %>% unique %>% length 
clymeanti040118$MemberId %>% is.na %>% table # no NA in memberID
clymeanti040118$d_NdcDesc %>% table(useNA = "always") 
clymeanti040118 %>% distinct %>% filter(!is.na(d_NdcDesc)) %>% .$MemberId %>% unique %>% length 




# ptlds
ptldsanti040118 %>% nrow 
ptldsanti040118 %>% distinct %>% nrow 
ptldsanti040118$MemberId %>% unique %>% length 
ptldsanti040118$MemberId %>% is.na %>% table
ptldsanti040118$d_NdcDesc %>% table(useNA = "always")
ptldsanti040118 %>% distinct %>% filter(!is.na(d_NdcDesc)) %>% .$MemberId %>% unique %>% length 
